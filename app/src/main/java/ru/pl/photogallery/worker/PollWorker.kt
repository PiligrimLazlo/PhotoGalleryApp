package ru.pl.photogallery.worker
...
import ru.pl.photogallery.MainActivity
import ru.pl.photogallery.NOTIFICATION_CHANNEL_ID
import ru.pl.photogallery.PreferencesRepository
import ru.pl.photogallery.R
...
class PollWorker(
    ...
    override suspend fun doWork(): Result {
        ...
        return try {
            ...
            Log.e(TAG, "Background result failed", ex)
            Result.failure()
        }
    }
